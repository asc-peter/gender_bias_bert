...
f = open('./result.txt', 'w')
f.write('남성명사가 주어진 경우 남성직업에 대해서: %f' %(1/score_m_and_ma))
f.write('\n')
f.write('남성명사가 주어진 경우 여성직업에 대해서: %f' %(1/score_m_and_fa))
f.write('\n')
f.write('여성명사가 주어진 경우 남성직업에 대해서: %f' %(1/score_f_and_ma))
f.write('\n')
f.write('여성명사가 주어진 경우 여성직업에 대해서: %f' %(1/score_f_and_fa))
f.write('\n')
f.write('남성직업이 주어진 경우 남성명사에 대해서: %f' %(1/score_ma_and_m))
f.write('\n')
f.write('남성직업이 주어진 경우 여성명사에 대해서: %f' %(1/score_ma_and_f))
f.write('\n')
f.write('여성직업이 주어진 경우 남성명사에 대해서: %f' %(1/score_fa_and_m))
f.write('\n')
f.write('여성직업이 주어진 경우 여성명사에 대해서: %f' %(1/score_fa_and_f))
f.write('\n')
